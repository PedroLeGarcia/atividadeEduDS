...
namespace AtCadastroAeS
{
    public partial class CadastroP : Form
    {
        ...
        private void PrintDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            strDados = strDados + "Descrição: " + txtDesc.Text + (char)10 + (char)10;
            strDados = strDados + "Unidades: " + txtUni.Text + (char)10 + (char)10;
            strDados = strDados + "Quantidade no estoque: " + txtQtd.Text + (char)10 + (char)10;
            strDados = strDados + "Preço de Custo: " + txtPC.Text + (char)10 + (char)10;
            strDados = strDados + "Preço de Venda: " + txtPV.Text + (char)10 + (char)10;
